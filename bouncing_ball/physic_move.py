...
while run:
    timer.tick(fps)
    screen.fill('black')
    mouse_coods = pygame.mouse.get_pos()
    mouse_trajectory.append(mouse_coods)
    ...
    ball2.draw()
    ball3.draw()
    ball1.update_pos(mouse_coods)
    ball2.update_pos(mouse_coods)
    ball3.update_pos(mouse_coods)
